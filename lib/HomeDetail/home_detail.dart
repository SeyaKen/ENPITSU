...
import 'package:eigo/Answer/answer_screen.dart';
import 'package:eigo/EditAnswer/edit_answer.dart';
import 'package:eigo/HomeDetail/picture_detail.dart';
import 'package:eigo/Othersprofile/others_profile.dart';
...
class HomeDetail extends StatefulWidget {
  ...
  @override
  State<HomeDetail> createState() =>
      _HomeDetailState(articleId, askerId, fromWhere);
}
                                                                        ...
                                                                        child: StreamBuilder<
                                                                            ...
                                                                            builder: (context, snapshot0) {
                                                                              return snapshot0.hasData
                                                                                  ? Image.network(
                                                                                      snapshot0.data!.docs[0]['ProfilePicture'] == '' ? 'https://firebasestorage.googleapis.com/v0/b/eigo-224ae.appspot.com/o/44884218_345707102882519_2446069589734326272_n.jpeg?alt=media&token=9cdb200e-9d19-4657-a861-711f87ad10f4' : snapshot0.data!.docs[0]['ProfilePicture'],
                                                                                      fit: BoxFit.cover,
                                                                                    )
                                                                                  : Image.network(
